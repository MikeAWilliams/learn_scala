...
def binarySearchGeneric[T: Ordering](items: Array[T], target: T):Int = {
    def binarySearchRecursive[T: Ordering](items: Array[T], target: T, startIndex: Int, stopIndex: Int) :Int = {
        val midIndex = (stopIndex + startIndex)/2
